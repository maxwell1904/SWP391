...
const getSaleStatusFromDates = (startDateValue, endDateValue) => {
...
const DashboardEditSale = () => {
  ...
  useEffect(() => {
    setLoading(true);
    apiClient
      .get(`/api/sales/${saleId}`, { headers: { Authorization: varToken } })
      .then((response) => {
